document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            motivation_text_2: '<strong>Matěj Šach</strong> studies entrepreneurship alongside sociology through the Finnish Tiimi Akatemia concept, which keeps the business side and work organisation under control.',
        ...
        cs: {
            ...
            motivation_text_2: '<strong>Matěj Šach</strong> k sociologii studuje podnikání podle finského konceptu Tiimi Akatemia, čímž drží byznysovou stránku a organizaci práce.',
